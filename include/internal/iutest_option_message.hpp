...
inline void iuOptionMessage::ShowFeature(void)
{
	...
	SHOW_MACRO(IUTEST_HAS_PEEP_CLASS);
	...
	SHOW_MACRO(IUTEST_HAS_REGEX);
	SHOW_MACRO(IUTEST_HAS_REPORT_SKIPPED);
	...
	SHOW_MACRO(IUTEST_HAS_STREAMCAPTURE);
...
inline void iuOptionMessage::ShowSpec(void)
{
	...
	SHOW_MACRO(IUTEST_HAS_COUNTER_MACRO);
