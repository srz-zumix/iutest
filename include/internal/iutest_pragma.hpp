...
#if !defined(IUTEST_PRAGMA_WARN_SUPPRESS_DESTRUCTOR_THROW_EXCEPTION)
#  if defined(_MSC_VER)
#    define IUTEST_PRAGMA_WARN_SUPPRESS_DESTRUCTOR_THROW_EXCEPTION()    IUTEST_PRAGMA_MSC_WARN_SUPPRESS(26447)
#  endif
#endif

#if !defined(IUTEST_PRAGMA_WARN_SUPPRESS_DESTRUCTOR_THROW_EXCEPTION)
#  define IUTEST_PRAGMA_WARN_SUPPRESS_DESTRUCTOR_THROW_EXCEPTION()
#endif
