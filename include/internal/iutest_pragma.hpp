...
#  elif defined(__GNUC__)
#    if (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 9))
#      define IUTEST_PRAGMA_WARN_DISABLE_IMPLICIT_FLOAT_CONVERSION()    IUTEST_PRAGMA_WARN_FLOAT_CONVERSION()
#    endif
#  elif defined(_MSC_VER)
#    define IUTEST_PRAGMA_WARN_DISABLE_IMPLICIT_FLOAT_CONVERSION()      IUTEST_PRAGMA_WARN_FLOAT_CONVERSION()
#  endif
...
#if !defined(IUTEST_PRAGMA_WARN_DISABLE_IMPLICIT_FLOAT_CONVERSION)
#  define IUTEST_PRAGMA_WARN_DISABLE_IMPLICIT_FLOAT_CONVERSION()
#endif
