...
#if defined(IUTEST_ASSUME_LONG_DOUBLE_EQ)
#define ASSUME_LONG_DOUBLE_EQ   IUTEST_ASSUME_LONG_DOUBLE_EQ
#endif
...
#define ASSUME_EQ(expected, actual) \
    ASSUME_PRED_FORMAT2(IIUT_COMPATIBLE_EQHELPER(expected)::Compare, \
    expected, actual)
...
#define IUTEST_ASSUME_DOUBLE_EQ             ASSUME_COMPLEX_EQ
