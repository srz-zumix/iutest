...
#if IUTEST_HAS_EXCEPTIONS && IUTEST_HAS_SEH
inline int	UnitTest::RunOnMSC(void)
{
...
inline int UnitTest::RunImpl(void)
{
	m_repeat_counter = 0;
...
inline bool	UnitTest::RunOnce(void)
{
	m_elapsedmsec = 0;
...
inline void	UnitTest::TestProgramStart(void)
{
#if 0
...
inline void	UnitTest::SetUpTestIteration(void)
{
	TestEnv::SetUp();
}

inline void	UnitTest::EnvironmentSetUp(void)
{
...
inline void	UnitTest::EnvironmentTearDown(void)
{
...
inline void	UnitTest::TestProgramEnd(void)
{
...
inline void	UnitTest::Initialize(void)
{
	m_init_iutest_count++;
