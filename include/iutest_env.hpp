...
inline bool TestEnv::ParseCommandLineElemA(const char* str)
{
	bool find = false;
	if( *str == '-' )
	{
...
inline void TestEnv::LoadEnviromentVariable(void)
{
	{
		int var = 0;
...
inline void	TestEnv::SetUp(void)
{
...
inline 	bool TestEnv::ParseColorOption(const char* option)
{
...
inline bool	TestEnv::ParseOutputOption(const char* option)
{
	if( option == NULL ) return false;
