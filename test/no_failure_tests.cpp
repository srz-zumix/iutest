...
IUTEST(NoFatalFailureTest, Assert)
{
    ...
    IUTEST_ASSERT_NO_FATAL_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFatalFailureTest, Expect)
{
    ...
    IUTEST_EXPECT_NO_FATAL_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFatalFailureTest, Inform)
{
    ...
    IUTEST_INFORM_NO_FATAL_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFatalFailureTest, Assume)
{
    ...
    IUTEST_ASSUME_NO_FATAL_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFailureTest, Assert)
{
    ...
    IUTEST_ASSERT_NO_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFailureTest, Expect)
{
    ...
    IUTEST_EXPECT_NO_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFailureTest, Inform)
{
    ...
    IUTEST_INFORM_NO_FAILURE(IUTEST_SKIP());
...
IUTEST(NoFailureTest, Assume)
{
    ...
    IUTEST_ASSUME_NO_FAILURE(IUTEST_SKIP());
